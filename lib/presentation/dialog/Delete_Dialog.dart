...
class DeleteDialog extends StatefulWidget {
  ...
  const DeleteDialog({super.key,  this.message, required this.onCallBack , });

  @override
  State<DeleteDialog> createState() => _ErrorOccuredDialogState();
}

class _ErrorOccuredDialogState extends State<DeleteDialog> {
  ...
  Widget getMessageText(double parentHeight,double parentWidth) {
    return Row(
      children: <Widget>[
        Expanded(
          child: Text(
              ApplicationLocalizations.of(context)!.translate("delete_msg")!,
              style: TextStyle(
                color: Colors.black,
