...
class ShowInformationDialog extends StatefulWidget {
  const ShowInformationDialog({super.key, required String message});

  @override
  State<ShowInformationDialog> createState() => _ShowInformationDialogState();
}

class _ShowInformationDialogState extends State<ShowInformationDialog> {
  ...
  Widget getMessageText(double parentHeight,double parentWidth) {
    return Row(
      children: <Widget>[
        Expanded(
          child: Text(
              ApplicationLocalizations.of(context)!.translate("internet_msg")!,
              style: TextStyle(
                color: Colors.black,
