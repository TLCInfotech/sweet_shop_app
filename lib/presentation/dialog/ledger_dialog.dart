...
class LedgerDialog extends StatefulWidget {
  final LedgerDialogInterface mListener;

  const LedgerDialog({super.key, required this.mListener});
              ...
              child: GestureDetector(
                onTap: (){
                  if(widget.mListener!=null){
                    widget.mListener.selectedLedger(ledger_list[index]['ID'].toString(),ledger_list[index]['Name']);
                  }
...
abstract class LedgerDialogInterface{
