...
class ParentGroupDialog extends StatefulWidget {
  final ParentGroupDialogInterface mListener;

  const ParentGroupDialog({super.key, required this.mListener});

  @override
  State<ParentGroupDialog> createState() => _ParentGroupDialogState();
}
...
class _ParentGroupDialogState extends State<ParentGroupDialog>{
  ...
  List state_list= ['New One', 'Last', 'Good Group'];
              ...
              child: GestureDetector(
                onTap: (){
                  if(widget.mListener!=null){
                    widget.mListener.selectParentG(index.toString(),state_list.elementAt(index));
                  }
...
abstract class ParentGroupDialogInterface{
