...
class SingleLineEditableTextFormFieldWithoubleDouble extends StatefulWidget{
  final title;
  ...
  SingleLineEditableTextFormFieldWithoubleDouble({required this.title,required this.callbackOnchage,required this.controller,required this.focuscontroller,required this.focusnext,required this.textInput,required this.maxlines,required this.format, this.parentWidth,  this.maxlength, required this.validation, this.suffix,  this.readOnly,  this.capital, this.txtkey,this.mandatory});

  @override
  State<SingleLineEditableTextFormFieldWithoubleDouble> createState() => _SingleLineEditableTextFormFieldState();
}

class _SingleLineEditableTextFormFieldState extends State<SingleLineEditableTextFormFieldWithoubleDouble> {
