...
class GetBankCashLedger extends StatefulWidget{
  final title;
  final bankCashLedger;
  final Function(String?,String?) callback;
  final titleIndicator;

  GetBankCashLedger({required this.title, required this.callback, required this.bankCashLedger,   this.titleIndicator});

  @override
  State<GetBankCashLedger> createState() => _SingleLineEditableTextFormFieldState();
}

class _SingleLineEditableTextFormFieldState extends State<GetBankCashLedger> with     SingleTickerProviderStateMixin,BankCashLedgerInterface {
              ...
              child: Container(
                ...
                child:  Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(widget.bankCashLedger == "" ? ApplicationLocalizations.of(context)!.translate("bank_cash_ledger")!  : widget.bankCashLedger,
  ...
  selectedbankCashLedgerInterface(String id, String name) {
    // TODO: implement selectedbankCashLedgerInterface
