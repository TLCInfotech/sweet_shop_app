...
class GetReportTypeLayout extends StatefulWidget{
  final title;
  final reportType;
  final Function(String?) callback;

  GetReportTypeLayout({required this.title, required this.callback, required this.reportType});

  @override
  State<GetReportTypeLayout> createState() => _GetReportTypeLayoutState();
}

class _GetReportTypeLayoutState extends State<GetReportTypeLayout> with     SingleTickerProviderStateMixin,ReportTypeDialogInterface {
