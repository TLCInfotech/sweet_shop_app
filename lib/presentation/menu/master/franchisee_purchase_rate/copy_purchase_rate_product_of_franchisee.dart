...
class _CopyPurchaseRateProductOfFranchiseeState extends State<CopyPurchaseRateProductOfFranchisee> with FranchiseeDialogInterface {
  ...
  selectedFranchisee(String id, String name) {
    ...
    if(widget.mListener!=null){
      widget.mListener.selectedFranchiseeToCopyPurchaseRateProduct(id,name);
    }
