...
class AddOrEditOrder extends StatefulWidget {
  final AddOrEditOrderInterface mListener;
  ...
  @override
  State<AddOrEditOrder> createState() => _AddOrEditOrderState();
}

class _AddOrEditOrderState extends State<AddOrEditOrder> {
        ...
        GestureDetector(
          onTap: () {
            ...
            if (widget.mListener != null) {
              widget.mListener.AddOrEditOrderDetail(item);
              Navigator.pop(context);
            }
          },
          onDoubleTap: () {},
...
//   final id;
//   final dateFinal;
//   const AddOrEditOrder({super.key, required this.mListener, required this.editproduct,required this.date, this.id, this.dateFinal});
//
//   @override
//   State<AddOrEditOrder> createState() => _AddOrEditOrderState();
// }
