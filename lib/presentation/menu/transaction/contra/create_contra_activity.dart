...
class _CreateContraState extends State<CreateContra>
    with SingleTickerProviderStateMixin, AddOrEditLedgerForContraInterface {
...
var voucherNo;
                ...
                onPressed: () async{
                  ...
                  if (selectedBankLedgerID != null) {
                    ...
                    CommonWidget.errorDialog(
                        context, "Select bank name first.");
                  }
                }),
          ),
        ),
                ...
                onTap: () {
                  ...
                  if (widget.readOnly == true) {
                    ...
                    if (context != null) {
                      goToAddOrEditItem(
                          Item_list[index],
                          DateFormat("yyyy-MM-dd").format(widget.newDate),
                          selectedBankLedgerID,
                          widget.companyId,
                          "edit");
                    }
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Item_list[index]['Remark'] != null
                                            ? Container(
                                                alignment: Alignment.centerLeft,
                                                width: SizeConfig.screenWidth,
                                                child: Text(
                                                  "${Item_list[index]['Remark']}",
                                                  overflow: TextOverflow.clip,
  ...
  Container ReceiptInfo() {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          widget.voucherNo == null
              ? Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Expanded(child: getReceiptDateLayout()),
                  ],
                )
              : Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  Widget getFranchiseeNameLayout(double parentHeight, double parentWidth) {
    return SearchableLedgerDropdown(
      ...
      franchiseeName:
          widget.come == "edit" ? widget.debitNote['Ledger_Name'] : "",
      title:
            ...
            if (data != null) {
              ...
              setState(() {
                ...
                selectedbankCashLedger =
                    data['accountVoucherHeader']['Ledger_Name'];
                selectedBankLedgerID =
    ...
    if (editedItemIndex != null) {
      ...
      if (item['Seq_No'] != null) {
        var contain = Updated_list.indexWhere(
            (element) => element['Ledger_ID'] == item['Ledger_ID']);
        print(contain);
        if (contain >= 0) {
          print("REMOVE");
