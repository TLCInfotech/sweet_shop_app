    ...
    if (netStatus == InternetConnectionStatus.connected) {
      AppPreferences.getDeviceId().then((deviceId) {
        ...
        if (selectedFranchiseeId != "") {
          apiUrl =
              "${baseurl}${ApiConstants().reports}?Company_ID=$companyId&${StringEn.lang}=$lang&Form_Name=Payment&Report_ID=${widget.reportId}&From_Date=${DateFormat("yyyy-MM-dd").format(applicablefrom)}&To_Date=${DateFormat("yyyy-MM-dd").format(applicableTwofrom)}&ID=$selectedFranchiseeId";
        } else if (selectedBankCashId != "") {
          apiUrl =
              "${baseurl}${ApiConstants().reports}?Company_ID=$companyId&${StringEn.lang}=$lang&Form_Name=Payment&Report_ID=${widget.reportId}&From_Date=${DateFormat("yyyy-MM-dd").format(applicablefrom)}&To_Date=${DateFormat("yyyy-MM-dd").format(applicableTwofrom)}&ID=$selectedBankCashId";
        } else {
          apiUrl =
              "${baseurl}${ApiConstants().reports}?Company_ID=$companyId&${StringEn.lang}=$lang&Form_Name=Payment&Report_ID=${widget.reportId}&From_Date=${DateFormat("yyyy-MM-dd").format(applicablefrom)}&To_Date=${DateFormat("yyyy-MM-dd").format(applicableTwofrom)}";
        }
  ...
  pdfDownloadCall(String urlType) async {
    ...
    if(netStatus==InternetConnectionStatus.connected){
      AppPreferences.getDeviceId().then((deviceId) async{
        ...
        String apiUrl ="";
        if (selectedFranchiseeId != "") {
          apiUrl =baseurl + ApiConstants().getAcctVoucherReports+"/Download?Company_ID=$companyId&${StringEn.lang}=$lang&From_Date=${DateFormat("yyyy-MM-dd").format(applicablefrom)}&To_Date=${DateFormat("yyyy-MM-dd").format(applicableTwofrom)}&Form_Name=Payment&Report_ID=${widget.reportId}&ID=$selectedFranchiseeId&Type=$urlType";
        } else if (selectedBankCashId != "") {
          apiUrl =baseurl + ApiConstants().getAcctVoucherReports+"/Download?Company_ID=$companyId&${StringEn.lang}=$lang&From_Date=${DateFormat("yyyy-MM-dd").format(applicablefrom)}&To_Date=${DateFormat("yyyy-MM-dd").format(applicableTwofrom)}&Form_Name=Payment&Report_ID=${widget.reportId}&ID=$selectedBankCashId&Type=$urlType";
        } else {
              apiUrl =baseurl + ApiConstants().getAcctVoucherReports+"/Download?Company_ID=$companyId&${StringEn.lang}=$lang&From_Date=${DateFormat("yyyy-MM-dd").format(applicablefrom)}&To_Date=${DateFormat("yyyy-MM-dd").format(applicableTwofrom)}&Form_Name=Payment&Report_ID=${widget.reportId}&Type=$urlType";
        }
