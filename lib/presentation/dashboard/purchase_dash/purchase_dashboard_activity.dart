  ...
  getSalePartyWise() async {
    ...
    if (netStatus == InternetConnectionStatus.connected){
      AppPreferences.getDeviceId().then((deviceId) {
        ...
        String apiUrl = "${baseurl}${ApiConstants().getDashboardSaleReturnPartywise}?Company_ID=$companyId&${StringEn.lang}=$lang&Date=${DateFormat("yyyy-MM-dd").format(saleDate)}";
        apiRequestHelper.callAPIsForGetAPI(apiUrl, model.toJson(), "",
            onSuccess:(data){
              ...
              setState(() {
                ...
                print("jejejnj   ${data['DashboardSaleReturnPartywise']}");
                if(data['DashboardSaleReturnPartywise']!=[]){
                  if (mounted) {
                    for (var item in data['DashboardSaleReturnPartywise']) {
  ...
  getSaleItemWise() async {
    ...
    if (netStatus == InternetConnectionStatus.connected){
      AppPreferences.getDeviceId().then((deviceId) {
        ...
        String apiUrl = "${baseurl}${ApiConstants().getDashboardSaleReturnItemwise}?Company_ID=$companyId&${StringEn.lang}=$lang&Date=${DateFormat("yyyy-MM-dd").format(saleDate)}";
        apiRequestHelper.callAPIsForGetAPI(apiUrl, model.toJson(), "",
            onSuccess:(data){
              ...
              setState(() {
                ...
                if(data!=null){
                  if (mounted) {
                    for (var item in data['DashboardSaleReturnItemwise']) {
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Text( ApplicationLocalizations.of(context).translate("go_to_credit_note"),style: subHeading_withBold.copyWith(color: Colors.white,fontSize: 18),),
    ...
    return  Expanded(
      child:RefreshIndicator(
          ...
          child: ListView(
            ...
            controller: _scrollController,
            physics: AlwaysScrollableScrollPhysics(),
            children: [_saleItem.length!=0? Container(
