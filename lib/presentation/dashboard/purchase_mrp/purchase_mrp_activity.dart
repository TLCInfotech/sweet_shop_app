...
import 'create_prchase_mrp_activity.dart';
...
class PurchaseMrpActivity extends StatefulWidget {
                      ...
                      if(widget.comeFor=="Return"){
                       await   Navigator.push(context, MaterialPageRoute(builder: (context) =>
                           CreatePurchaseMrpActivity(
                              ...
                              apiUrl:ApiConstants().getReturnMRPDetails,
                              come:"edit",
                            )));
                      }else{
                        await   Navigator.push(context, MaterialPageRoute(builder: (context) =>
                            CreatePurchaseMrpActivity(
                              ...
                              readOnly:singleRecord['Update_Right'] ,
                              editedItem:saleInvoice_list[index],
                              apiUrl:ApiConstants().getSaleMRPDetails,
                              come:"edit",
                            )));
                      }
