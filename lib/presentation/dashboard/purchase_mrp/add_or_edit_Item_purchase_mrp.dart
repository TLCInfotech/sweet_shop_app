...
class AddOrEditIPurchaseMrpActivity extends StatefulWidget {
  final AddOrEditIPurchaseMrpActivityInterface mListener;
  ...
  final dateFinal;
  final exstingList;
  const AddOrEditIPurchaseMrpActivity(
      {super.key,
  ...
  @override
  State<AddOrEditIPurchaseMrpActivity> createState() => _AddOrEditIPurchaseMrpActivityState();
}

class _AddOrEditIPurchaseMrpActivityState extends State<AddOrEditIPurchaseMrpActivity> {
  ...
  void initState() {
    ...
    super.initState();
    print("vvhhhhhdddddddd  ${widget.editproduct}");
    setVal();
  }
  List insertedList=[];
  ...
  Widget getAddSearchLayout(double parentHeight, double parentWidth) {
    return SearchableDropdownWithExistingList(
      ...
      come: widget.editproduct!=null?"dis":"",
          ...
          onTap: () {
            ...
            if (selectedItemID!=null && v && q && r) {
              ...
              if (widget.mListener != null) {
                widget.mListener.AddOrEditIPurchaseMrpActivityDetail(item);
                Navigator.pop(context);
              }
            } else {
       }
...
abstract class AddOrEditIPurchaseMrpActivityInterface {
  AddOrEditIPurchaseMrpActivityDetail(dynamic item);
}
