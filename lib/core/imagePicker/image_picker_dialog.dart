...
class ImagePickerDialog extends StatelessWidget {
  ...
  late final String isOpenFrom;
  late final ImagePickerDialogInterface mListener;
  late final String comeFrom;


  late Animation<double> _drawerContentsOpacity;
  late Animation<Offset> _drawerDetailsPosition;

  ImagePickerDialog(this._listener,this._controller,this.mListener,this.context,this.comeFrom,this.isOpenFrom, {super.key});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                //       color: CommonColor.PRE_LOGIN_BUTTON_COLOR,
...
abstract class ImagePickerDialogInterface {}
